...
<div class="workstep"><div class="worklabel">Marca:</div><div class="workfields"><input type="text" validate="uppercase~required.yes" class="autocompletefield validated ac_input validateatention" lk="coduri/code.php?soc=allianz&amp;grupa=marci&amp;valoare=&amp;lookupfor=marca" name="marca" mustmatch="yes" size="20" id="marca" value="" autocomplete="off" title="Talon nou: D.1, Talon vechi: 8">
</div></div>
